...
public class Touple implements Serializable {
    ...
    public Touple computation(BigDecimal computation) {
    ...
    public Touple time(ZonedDateTime time) {
        this.setTime(time);
        return this;
    }
    ...
    public Touple calculation(Calculation calculation) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Touple)) {
            return false;
        }
        return id != null && id.equals(((Touple) o).id);
    }
