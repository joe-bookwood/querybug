...
describe('Chart Management Delete Component', () => {
  let comp: ChartDeleteDialogComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ChartDeleteDialogComponent],
      providers: [NgbActiveModal],
    })
      .overrideTemplate(ChartDeleteDialogComponent, '')
      .compileComponents();
